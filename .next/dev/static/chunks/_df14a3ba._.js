...
function Page() {
    ...
    const favorites = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Page.useMemo[favorites]": ()=>favoriteCandidates.filter({
                "Page.useMemo[favorites]": (product)=>favoriteIds.includes(product.id)
            }["Page.useMemo[favorites]"])
    }["Page.useMemo[favorites]"], [
        favoriteIds
    ]);
...
_s(Page, "+dVX3Q9u3+Bhc7yU7F0GmAc9cKE=");
_c = Page;
var _c;
